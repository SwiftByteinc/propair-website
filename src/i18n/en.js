const en = {
  ...
  dashboard: {
    ...
    // Coming Soon
    sideComingSoon: 'Coming soon',
    badgeSoon: 'Soon',
    comingSoonSection: 'Coming soon',
    comingSoonHomeDesc: 'We\'re building new features for you. Vote for the ones you\'re most interested in!',
    comingSoonHomeLink: 'See what\'s coming',
    comingSoonTitle: 'Coming Soon — My ProPair Space',
    comingSoonHeading: 'Coming soon',
    comingSoonSubtitle: 'Discover what\'s coming next to ProPair.',
    comingSoonReferralTitle: 'Referral program',
    comingSoonReferralDesc: 'Invite your colleagues and contacts to join ProPair. Each validated referral will earn you free subscription months. Be among the first to know when it launches.',
    comingSoonJoinWaitlist: 'Join the early access list',
    comingSoonJoined: 'You\'re on the list!',
    comingSoonLabTitle: 'In our lab',
    comingSoonLabSubtitle: 'Vote for the features you\'re most interested in.',
    comingSoonFeature1Title: 'Referral program',
    comingSoonFeature1Desc: 'Earn free Pro months by inviting other entrepreneurs and clients.',
    comingSoonFeature2Title: 'CRM integrations',
    comingSoonFeature2Desc: 'Sync your contacts and projects with your existing tools.',
    comingSoonFeature3Title: 'Automated quotes',
    comingSoonFeature3Desc: 'Generate and send professional quotes directly from the app.',
    comingSoonVote: 'Vote',
    comingSoonVoted: 'Voted!',
    comingSoonThanks: 'Thank you for your votes! They help us prioritize our roadmap.',
