      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <Link
              to="/"
              className="group focus:outline-none focus:ring-2 focus:ring-teal-700 rounded-lg p-1"
            ...
            <nav ref={navRef} className="hidden md:flex items-center space-x-6 relative" aria-label="Navigation principale">
              ...
              <motion.span
                className="absolute bottom-0 h-0.5 bg-teal-700 rounded-full pointer-events-none"
                animate={{
                  left: indicator.left,
            ...
            <button
              ...
              className="md:hidden w-11 h-11 flex items-center justify-center rounded-xl bg-slate-50 text-slate-600 hover:bg-slate-100 transition-colors focus:outline-none focus:ring-2 focus:ring-teal-700"
            >
            ...
            >
              <div className="flex items-center justify-between p-6 border-b border-slate-100">
                ...
                <button
                  ...
                  autoFocus
                  className="w-10 h-10 flex items-center justify-center rounded-xl bg-slate-50 text-slate-500 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-teal-700"
                >
