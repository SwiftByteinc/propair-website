      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-12 sm:mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/pricing" className="text-slate-600 hover:text-cyan-600 transition-colors">
              ...
              <li>
                <Link to="/pricing#faq" className="text-slate-600 hover:text-cyan-600 transition-colors">
                  {t('footer.productFaq')}
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-slate-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm text-slate-500">
            <Link to="/privacy" className="hover:text-cyan-600 transition-colors">
              {t('footer.legalPrivacy')}
            </Link>
            <Link to="/terms" className="hover:text-cyan-600 transition-colors">
              {t('footer.legalTerms')}
            </Link>
            <Link to="/refund" className="hover:text-cyan-600 transition-colors">
