      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-12 sm:mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link to="/pricing#faq" className="text-slate-600 hover:text-teal-600 transition-colors">
                  FAQ
                </Link>
              </li>
            </ul>
          ...
          {/* Company Links */}
          <div>
            <h3 className="font-bold text-slate-900 mb-6">Entreprise</h3>
            <ul className="space-y-4">
              <li>
          ...
          {/* Télécharger */}
          <div>
            <h3 className="font-bold text-slate-900 mb-6">Télécharger l'app</h3>
            <p className="text-slate-600 mb-4">Disponible gratuitement sur iOS et Android.</p>
            <div className="space-y-3">
              <a
                href="https://apps.apple.com/app/propair"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex justify-center items-center gap-2.5 px-4 py-3 bg-slate-900 hover:bg-black text-white font-semibold rounded-xl transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex justify-center items-center gap-2.5 px-4 py-3 bg-slate-900 hover:bg-slate-800 text-white font-semibold rounded-xl transition-colors"
              >
        ...
        <div className="border-t border-slate-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm text-slate-500">
            ...
            <Link to="/refund" className="hover:text-teal-600 transition-colors">
              Remboursement
            </Link>
          </div>
        </div>
