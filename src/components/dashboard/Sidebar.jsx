      ...
      `}>
        ...
        <div className="p-6 border-b border-slate-50">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-teal-700 text-teal-700 flex items-center justify-center font-bold text-sm">
          ...
          {links.map((link) => (
            <NavLink
              ...
              className={({ isActive }) => `
                ...
                ${isActive
                  ? 'bg-teal-700 text-teal-700 border-l-2 border-teal-700'
