        ...
        >
          ...
          <section className="mb-12">
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
              <div className="flex items-start gap-3">
                <Building2 size={20} className="text-cyan-600 mt-1" />
                <div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                <div className="flex items-start gap-3">
                  <Scale size={20} className="text-cyan-600 mt-1" />
                  <div>
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                <div className="flex items-start gap-3">
                  <CreditCard size={20} className="text-cyan-600 mt-1" />
                  <div>
          ...
          <section className="mb-12">
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
              <div className="flex items-start gap-3">
                <MessageSquare size={20} className="text-cyan-600 mt-1" />
                <div>
                  <p className="text-slate-600 leading-relaxed mb-4">
                    {t('terms.s4P1')}
                  </p>
          ...
          <section className="mb-12">
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
              <div className="flex items-start gap-3">
                <Gavel size={20} className="text-cyan-600 mt-1" />
                <div>
