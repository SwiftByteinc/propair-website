            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-slate-600"><strong>{t('privacy.s2EmailLabel')}</strong> <a href="mailto:privacy@propairapp.com" className="text-teal-600 hover:underline">privacy@propairapp.com</a></span>
                </div>
                <div className="flex items-center gap-3">
          ...
          <section className="mb-12">
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
              ...
              <p className="text-slate-600 leading-relaxed">
                {t('privacy.s4P2')} <a href="mailto:privacy@propairapp.com" className="text-teal-600 hover:underline">privacy@propairapp.com</a>.
              </p>
            </div>
          </section>
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
              ...
              <div className="bg-teal-50 rounded-xl p-4 border border-teal-100">
                <p className="text-slate-600">
                  <strong>{t('privacy.s7DeletionTitle')}</strong> {t('privacy.s7DeletionDesc')} <a href="mailto:privacy@propairapp.com" className="text-teal-600 hover:underline">privacy@propairapp.com</a>. {t('privacy.s7DeletionDelay')} <strong>{t('privacy.s7DeletionDays')}</strong>.
                </p>
              </div>
            </div>
          </section>
