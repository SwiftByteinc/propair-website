        ...
        {isPro ? (
          <>
            ...
            <motion.section
              ...
              animate={{ opacity: 1, y: 0 }}
              className="bg-gradient-to-br from-cyan-50 to-white rounded-2xl border border-cyan-100/60 shadow-sm p-6"
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-xl bg-cyan-100 flex items-center justify-center">
                    <Crown size={24} className="text-cyan-700" />
                  </div>
                  <div>
                    <p className="text-xs font-medium text-cyan-600">{t('dashboard.activePlan')}</p>
          ...
          <div className="grid md:grid-cols-2 gap-6 items-start">
            ...
            <motion.section
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="bg-white rounded-2xl p-6 sm:p-8 border border-cyan-200/60 shadow-sm relative overflow-hidden flex flex-col justify-between"
            >
              {/* Badge */}
              <div className="absolute top-5 right-5">
                <span className="bg-cyan-600 text-white text-[10px] font-medium px-2.5 py-0.5 rounded-full flex items-center gap-1">
              ...
              <div>
                ...
                <p className="text-cyan-600 font-medium text-sm mb-5">{t('pricing.annualTagline')}</p>
                ...
                {/* Early Bird */}
                {isEarlyBird && (
                  <div className="mb-6 p-3 bg-cyan-50 rounded-xl border border-cyan-100">
                    <p className="text-xs font-semibold text-cyan-800">{t('pricing.earlyBirdLabel')}</p>
                ...
                <div className="space-y-3 mb-6 pt-6 border-t border-slate-100">
                  ...
                  {[t('pricing.feature1'), t('pricing.feature2'), t('pricing.feature3'), t('pricing.feature4'), t('pricing.feature5')].map((feat, i) => (
                    <div key={i} className="flex items-start gap-2.5">
                      <div className="w-5 h-5 bg-cyan-50 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
