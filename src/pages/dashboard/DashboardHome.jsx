      ...
      {isEntrepreneur ? (
        <>
          ...
          >
            <Link
              to="/portal/billing"
              className="p-4 bg-white rounded-xl border border-gray-100 hover:border-teal-200 hover:shadow-sm transition-all group"
            >
              <CreditCard size={20} className="text-gray-400 group-hover:text-teal-600 mb-2" />
              <p className="font-semibold text-sm text-gray-900">Abonnement</p>
              <p className="text-xs text-gray-400">Factures et paiement</p>
            </Link>

            <a
              href="mailto:support@propair.ca"
              className="p-4 bg-white rounded-xl border border-gray-100 hover:border-teal-200 hover:shadow-sm transition-all group"
            >
              <HelpCircle size={20} className="text-gray-400 group-hover:text-teal-600 mb-2" />
        ...
        <>
          ...
          <div className="grid grid-cols-2 gap-4">
             <Link to="/about" className="p-4 bg-white rounded-xl border border-gray-100 hover:border-teal-100 hover:shadow-sm transition-all">
                <Briefcase size={20} className="text-gray-400 mb-2" />
                <p className="font-semibold text-sm">À propos</p>
             </Link>
             <Link to="/portal/referral" className="p-4 bg-white rounded-xl border border-gray-100 hover:border-teal-100 hover:shadow-sm transition-all">
                <Gift size={20} className="text-gray-400 mb-2" />
