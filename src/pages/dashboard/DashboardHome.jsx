        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <div className={`w-14 h-14 rounded-2xl flex items-center justify-center ${
              user?.isPro ? 'bg-cyan-100 text-cyan-700' : 'bg-amber-100 text-amber-700'
            }`}>
            ...
            <div>
              <div className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[11px] font-semibold mb-1 ${
                user?.isPro ? 'bg-cyan-100 text-cyan-800' : 'bg-amber-100 text-amber-800'
              }`}>
                {user?.isPro ? (
                  <>
                    <Shield size={12} />
        ...
        <>
          ...
          >
            <div className="px-6 py-4 border-b border-slate-50 flex items-center justify-between">
              ...
              <Link to="/portal/referral" className="text-xs font-semibold text-cyan-600 hover:text-cyan-700">
                {t('dashboard.seeAll')}
              </Link>
            </div>
          ...
          >
            ...
            >
              <CreditCard size={20} className="text-slate-500 group-hover:text-cyan-600 mb-2" />
            ...
            <a
              ...
              className="p-4 bg-white rounded-xl border border-slate-100/60 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all group"
            >
              <HelpCircle size={20} className="text-slate-500 group-hover:text-cyan-600 mb-2" />
