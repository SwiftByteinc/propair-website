      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-slate-100 shadow-sm text-slate-600 text-xs sm:text-sm font-medium mb-6">
            <ReceiptText size={14} className="text-cyan-600" />
        ...
        >
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                <div className="flex items-start gap-3">
                  <Calendar size={20} className="text-cyan-600 mt-1" />
                  <div>
                ...
                <div>
                  ...
                  <ul className="text-slate-600 space-y-3">
                    <li className="flex items-start gap-2">
                      <span className="w-6 h-6 bg-cyan-100 rounded-full flex items-center justify-center text-cyan-600 text-sm font-semibold flex-shrink-0">1</span>
                      <span>{t('refund.s3Case1')}</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-6 h-6 bg-cyan-100 rounded-full flex items-center justify-center text-cyan-600 text-sm font-semibold flex-shrink-0">2</span>
                      <span>{t('refund.s3Case2')}</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-6 h-6 bg-cyan-100 rounded-full flex items-center justify-center text-cyan-600 text-sm font-semibold flex-shrink-0">3</span>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-xl font-bold text-cyan-600 hover:underline"
                  >
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              >
                <div className="w-10 h-10 bg-cyan-50 rounded-lg flex items-center justify-center">
                  <ReceiptText size={18} className="text-cyan-600" />
                </div>
