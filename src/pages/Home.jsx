...
export default function Home() {
  const { t } = useLanguage();
  return (
    <div className="w-full overflow-hidden bg-white font-sans selection:bg-cyan-50 selection:text-cyan-700">
      <SEO
        canonical="/"
      ...
      <section className="relative min-h-[calc(100vh-80px)] flex items-center overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-cyan-50/50 via-white to-white" />
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-slate-900 leading-[1.1] mb-6 md:mb-8 tracking-tight">
              ...
              <span className="text-cyan-600 relative inline-block">
                {t('home.heroTitle2')}
                <svg className="absolute -bottom-1 md:-bottom-2 left-0 w-full h-2 md:h-3 text-cyan-400 opacity-60" viewBox="0 0 300 12" fill="none"><path d="M2 9.5C55.5 3.5 168.5 -1.5 298 9.5" stroke="currentColor" strokeWidth="4" strokeLinecap="round"/></svg>
              </span>
            </h1>
            ...
            <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-3 sm:gap-6 justify-center text-sm font-medium text-slate-500 px-4 sm:px-0">
              <div className="flex items-center justify-center gap-2">
                <Check size={18} className="text-cyan-600" /> {t('home.badgeCommission')}
              </div>
              <div className="flex items-center justify-center gap-2">
                <Check size={18} className="text-cyan-600" /> {t('home.badgeTools')}
              </div>
              <div className="flex items-center justify-center gap-2 col-span-2 sm:col-span-1">
                <Check size={18} className="text-cyan-600" /> {t('home.badgeChat')}
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-20 md:py-32 bg-white border-t border-slate-100 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-6xl mx-auto">
            ...
            >
              <Users size={24} className="text-cyan-600 mb-6 md:mb-8" />
              <h3 className="text-xl md:text-2xl font-semibold text-slate-900 mb-2">{t('home.clientTitle')}</h3>
              <p className="text-base md:text-lg font-medium text-cyan-600 mb-4 md:mb-6">{t('home.clientTagline')}</p>
              ...
              <ul className="space-y-3 md:space-y-4">
                ...
                <li className="flex items-start gap-3">
                  <Layout size={16} className="text-cyan-600 mt-0.5 shrink-0" />
                  <span className="text-slate-700 text-sm md:text-base">{t('home.clientFeature2')}</span>
                </li>
                <li className="flex items-start gap-3">
                  <Check size={16} className="text-cyan-600 mt-0.5 shrink-0" />
            ...
            >
              ...
              <ul className="space-y-3 md:space-y-4">
                <li className="flex items-start gap-3">
                  <Clock size={16} className="text-cyan-600 mt-0.5 shrink-0" />
      ...
      <section className="py-20 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto relative">
            <div className="hidden md:block absolute top-12 left-[16.67%] right-[16.67%] h-px bg-gradient-to-r from-cyan-200 via-slate-200 to-cyan-200" />

            <div className="text-center relative bg-slate-50 rounded-2xl p-6 md:p-8 border border-slate-100/60 shadow-sm">
              <Search size={24} className="text-cyan-600 mx-auto mb-4 md:mb-6 relative z-10" />
            ...
            <div className="text-center relative bg-slate-50 rounded-2xl p-6 md:p-8 border border-slate-100/60 shadow-sm">
              <Layout size={24} className="text-cyan-600 mx-auto mb-4 md:mb-6 relative z-10" />
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 md:gap-8">
                <div className="relative group">
                  <img
                    ...
                    alt="ProPair App"
                    className="w-24 h-24 md:w-32 md:h-32 rounded-[22%] shadow-2xl shadow-black/30 flex-shrink-0 group-hover:scale-105 transition-transform duration-500"
                    loading="lazy"
                  />
                </div>
