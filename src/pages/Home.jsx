        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16 md:pt-32 md:pb-24 relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center mb-12 md:mb-16 px-4 sm:px-0">
              <a
                href="#telecharger"
                className="group flex items-center justify-center gap-3 px-8 py-4 bg-slate-900 hover:bg-black text-white font-bold rounded-xl transition-all hover:-translate-y-0.5 w-full sm:w-auto active:scale-[0.98] duration-200 shadow-lg shadow-slate-900/10"
              >
                <Smartphone size={20} />
                {t('home.ctaDownload')}
              ...
              <Link
                to="/pricing"
                className="group flex items-center justify-center gap-3 px-8 py-4 bg-white text-slate-700 border border-slate-200 font-semibold rounded-xl transition-all hover:border-slate-300 hover:text-slate-900 w-full sm:w-auto active:scale-[0.98] duration-200"
              >
                <Briefcase size={20} />
                {t('home.ctaPro')}
              </Link>
            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center lg:justify-end w-full sm:w-auto">
                <a
                  ...
                  className="flex items-center justify-center gap-3 px-6 py-3 md:py-4 bg-white hover:bg-slate-100 text-slate-900 rounded-xl transition-all shadow-lg hover:-translate-y-0.5 w-full sm:w-auto active:scale-[0.98] duration-200"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-3 px-6 py-3 md:py-4 bg-white/10 hover:bg-white/15 text-white border border-white/20 rounded-xl transition-all hover:-translate-y-0.5 w-full sm:w-auto active:scale-[0.98] duration-200"
                >
