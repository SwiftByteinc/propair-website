...
import { Mail, Lock, Eye, EyeOff, ArrowRight, User, Loader2, AlertCircle, Briefcase } from 'lucide-react';
      ...
      >
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            disabled={loading}
            className="w-full py-3 px-5 bg-white hover:bg-slate-50 border border-slate-200 hover:border-slate-300 rounded-xl shadow-sm transition-all flex items-center justify-center gap-3 text-sm font-medium text-slate-800 disabled:opacity-50 active:scale-[0.98]"
          >
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 px-5 bg-black hover:bg-neutral-900 text-white rounded-xl shadow-sm shadow-black/20 transition-all flex items-center justify-center gap-3 text-sm font-medium disabled:opacity-50 active:scale-[0.98]"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-black hover:bg-neutral-900 text-white font-semibold py-3.5 rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-50 shadow-lg shadow-black/15 active:scale-[0.98] mt-2"
          >
            {loading ? (
